...
import com.romiusse.server_api.transmitter.ServerAnswer
import com.romiusse.server_api.transmitter.ServerErrors
...
import com.romiusse.todo_list.screen.snack_bar_msg.SnackBarMessage
...
import com.romiusse.utils.Utils.convertClientModelToServer
import com.romiusse.utils.Utils.convertServerModelToClient
...
class MainScreenViewModel constructor(
    ...
    class Factory @Inject constructor(
        ...
        private val serverTransmitter: Provider<ServerTransmitter>,
        private val bottomSheetUtils: Provider<BottomSheetUtils>,
    ) : ViewModelProvider.Factory {

        @Suppress("UNCHECKED_CAST")
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            require(modelClass == MainScreenViewModel::class.java)
            return MainScreenViewModel(todoItemsRepository.get(),
                serverTransmitter.get(),
                bottomSheetUtils.get()) as T
        }
    }
